...
public class CascadeDeleteTest {
    ...
    public void deleteEdgeStartNode() {
        ...
        helper.verifyCounts(changeAtlas, helper.override(ItemType.NODE, -1), helper.override(ItemType.EDGE, -2));
    }
    ...
    public void testDeleteForwardEdgeToRelationMemberCascadeButNotReverseEdge() {
        ...
        helper.deleteEdgeButNotReverse(edgeIdentifier, CascadeDeleteTestRule.EDGE_RELATION_IDENTIFIER);
    }
