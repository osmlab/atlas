...
public class TagChangeTestRule extends CoreTestRule {
    ...
    @TestAtlas(
            ...
            nodes = {
                    @TestAtlas.Node(id = ID_STR_1, coordinates = @TestAtlas.Loc(value = NODE), tags = {HELLO_WORLD,
                            CHANGE_ME, DELETE_ME}),

                    @TestAtlas.Node(id = ID_STR_2, coordinates = @TestAtlas.Loc(value = EDGE_1), tags = {MARS_ROVER,
                            SINGLETON_EMPTY}),
            ...
            points = {
                    @TestAtlas.Point(id = ID_STR_1, coordinates = @TestAtlas.Loc(value = NODE), tags = {HELLO_WORLD,
                            CHANGE_ME, DELETE_ME}),

                    @TestAtlas.Point(id = ID_STR_2, coordinates = @TestAtlas.Loc(value = EDGE_1), tags = {MARS_ROVER,
                            SINGLETON_EMPTY}),
            },

            edges = {
                    @TestAtlas.Edge(id = ID_STR_1, coordinates = {
                            @TestAtlas.Loc(value = EDGE_1), @TestAtlas.Loc(value = EDGE_2), @TestAtlas.Loc(value =
                            EDGE_3)}, tags = {HELLO_WORLD, CHANGE_ME, DELETE_ME}),

                    @TestAtlas.Edge(id = ID_STR_2, coordinates = {@TestAtlas.Loc(value = EDGE_1),
                            @TestAtlas.Loc(value = EDGE_3)}, tags = {MARS_ROVER, SINGLETON_EMPTY})

            },

            lines = {
                    @TestAtlas.Line(id = ID_STR_1, coordinates = {
                            @TestAtlas.Loc(value = EDGE_1), @TestAtlas.Loc(value = EDGE_2), @TestAtlas.Loc(value =
                            EDGE_3)}, tags = {HELLO_WORLD, CHANGE_ME, DELETE_ME}),
            ...
            areas = {
                    @TestAtlas.Area(id = ID_STR_1, coordinates = {
                            @TestAtlas.Loc(value = AREA_1),
                            @TestAtlas.Loc(value = AREA_2),
                            @TestAtlas.Loc(value = AREA_3),
                            @TestAtlas.Loc(value = AREA_6),
                            @TestAtlas.Loc(value = AREA_7)},
                            tags = {HELLO_WORLD, CHANGE_ME, DELETE_ME}
                    ),

                    @TestAtlas.Area(id = ID_STR_2, coordinates = {
                            @TestAtlas.Loc(value = AREA_1),
                            @TestAtlas.Loc(value = AREA_4),
                            @TestAtlas.Loc(value = AREA_5),
                            @TestAtlas.Loc(value = AREA_7)},
                            tags = {MARS_ROVER, SINGLETON_EMPTY}
                    ),
            },

            relations = {
                    @TestAtlas.Relation(id = ID_STR_1, members = {
                            ...
                            @TestAtlas.Relation.Member(id = ID_STR_1, role = "some role 3", type = "area"),},
                            tags = {HELLO_WORLD, CHANGE_ME, DELETE_ME}
                    ),
                    ...
                    @TestAtlas.Relation(id = ID_STR_2, members = {
                            ...
                            @TestAtlas.Relation.Member(id = ID_STR_2, role = "some role 6", type = "relation"),},
                            tags = {MARS_ROVER, SINGLETON_EMPTY}
                    )
            }
    )
