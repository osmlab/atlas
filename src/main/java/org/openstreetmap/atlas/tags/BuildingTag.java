...
public enum BuildingTag
{
    ...
    private static EnumSet<BuildingTag> VALID_BUILDINGS = EnumSet.of(YES, RESIDENTIAL, COMMERCIAL,
            ...
            CABIN, FARM, WAREHOUSE, CIVIC, COLLAPSED, OFFICE, UNIVERSITY, HOTEL, DORMITORY, BUNGALOW,
            STATIC_CARAVAN, CHAPEL, MOSQUE, KINDERGARTEN, HOSPITAL, STADIUM, TRAIN_STATION, TRANSPORTATION,
            PUBLIC, BUNKER, GARAGES, HANGAR, STABLE, TRANSFORMER_TOWER, RUINS);
