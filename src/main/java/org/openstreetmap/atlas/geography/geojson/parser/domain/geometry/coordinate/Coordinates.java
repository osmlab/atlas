...
public class Coordinates<V> {
    ...
    private static List<List<Position>> toListOfPositionList(final List<List<List<Double>>> data) {
        ...
        return data.stream().map(listOfCoords -> toPositionList(listOfCoords)).collect(Collectors.toList());
    }
    ...
    public static Coordinates<List<List<Position>>> forMultiLineString(final List<List<List<Double>>> data) {
    ...
    public static Coordinates<List<List<Position>>> forMultiPolygon(final List<List<List<Double>>> data) {
