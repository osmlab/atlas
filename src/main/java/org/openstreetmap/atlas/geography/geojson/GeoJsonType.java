...
public enum GeoJsonType
{
        ...
        private static final EnumSet GEOMETRY_TYPES = EnumSet.of(POINT, MULTI_POINT,LINESTRING,MULTI_LINESTRING,POLYGON,MULTI_POLYGON,GEOMETRY_COLLECTION);
        ...
        public boolean isGeometryType(final GeoJsonType type)
        {
            return GEOMETRY_TYPES.contains(type);
        }

        public boolean isFeatureType(final GeoJsonType type)
        {
