...
class IdentifierConversionTest(unittest.TestCase):
    ...
    def test_osm_conversion(self):
        ...
        osm_id = 222222
        self.assertEqual(osm_id, identifier_conversion.get_osm_identifier(atlas_id))
    ...
    def test_country_code_conversion(self):
        atlas_id = 222222000000
        country_code = 0
        self.assertEqual(country_code, identifier_conversion.get_country_code(atlas_id))
    ...
    def test_way_section_conversion(self):
        atlas_id = 222222000000
        way_section = 0
        self.assertEqual(way_section, identifier_conversion.get_way_section_index(atlas_id))
